...
@pytest.fixture
def test_urls():
    return ['https://www.forbes.com/sites/robtoews/2022/03/27/a-wave-of-billion-dollar-language-ai-startups-is-coming/?utm_source=pocket_mylist&sh=63f8bc7f2b14',
...
def test_scrape_website_to_dict(urls):
    ...
    generated_docs_filenames = list(set([x['meta']['file_name'] for x in generated_docs]))
